...
<?php
 ...
 if (isset($_POST)&& !empty($_POST))	{
	...
	if($x == '0')
	{
		echo("<script>window.alert('High Possibility of user being Blue Color Blind')</script>"); 
	}
	elseif($x == '1')
	{
		echo("<script>window.alert('Low Possibility of user being Blue Color BLind ')</script>");
	}
...
<head>
  ...
  <div class="main-nav">
   ...
   <html>
<img src="Ishihara\2.jpg" alt="plate2">
</html>
