...
<?php
	...
	$amount = $_POST['amount'];
		...
		$query = "INSERT INTO donation (first,last,email,amount) VALUES ('$first','$last','$email',$amount);";
...
<head>
  ...
  <div class="main-nav">
	...
	<div class="module">
      ...
      <input type="number" name = "amount" placeholder="Amount" class="number" required/>
	  <button onclick="myFunction()" class= "button" name="Donate" value="save" > Donate</button>
	<script>
		function myFunction() 
		{
		alert("Thanking you for your generous donation.");
		}
	</script>
	</form>
	</div>
