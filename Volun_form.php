...
<?php
	...
	$phone = $_POST['phone'];
		...
		$query = "INSERT INTO volunteer (first,last,email,phone) VALUES ('$first','$last','$email','$phone');";
...
<div id="bg">
  <div class="module">
      ...
      <input type="text" name="first" placeholder="First Name" class="textbox" />
	  ...
	  <input type="tel" name="phone" placeholder="Contact Number" class="number" />
	  <button onclick="myFunction()" class="button" value ="save" >Register</button>
	  
	<script>
		function myFunction() 
		{
		alert("Thanking you for your generous participation.");
		}
	</script>
